...
export default function IndexDuration() {
  ...
  return (
    <div>
      ...
      <button
        onClick={() => {
          lapArray.push(createLap);
          console.log(lapArray);
          lapListElement.appendChild(addLap);
          lapList.appendChild(lapListElement);
        }}
      >
        Lap
      </button>
      <br></br>
      <h2>Laps</h2>
      <ul style={{ listStyleType: "none", padding: "0" }} id="lapList"></ul>
    </div>
  );
}
